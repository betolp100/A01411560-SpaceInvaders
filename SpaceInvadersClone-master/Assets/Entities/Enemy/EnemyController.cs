...
public class EnemyController : MonoBehaviour {
    private Vector3 zOffest = new Vector3(0,0,0);
	...
	void Die() {
        ...
        GameObject smokePuff = Instantiate(smoke, transform.position+zOffest, Quaternion.identity);
        Debug.Log("BYEBYE"+ smokePuff.transform.position);
